    ...
    return (
        <div className="glass-dark rounded-3xl p-8 border border-white/10 shadow-2xl w-full max-w-md animate-fade-in">
            <div className="text-center mb-8">
                ...
                <h1 className="mt-6 font-display text-2xl font-bold text-white">{t("auth.welcome_back")}</h1>
                <p className="text-slate-400 text-sm mt-1">{t("auth.manage_account")}</p>
                    ...
                    <div className="space-y-2">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 rounded-xl border border-white/10 bg-white/5 text-sm text-white placeholder:text-slate-500 focus:ring-2 focus:ring-brand-500/50 outline-none transition-all"
                            />
                        </div>
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 text-sm text-white placeholder:text-slate-500 focus:ring-2 focus:ring-brand-500/50 outline-none transition-all"
                            />
                        </div>
                    </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5">
                <p className="text-center text-sm text-slate-400">
                    {t("auth.footer_register")}{" "}
                    <Link href="/register" className="text-brand-400 font-bold hover:text-brand-300">{t("auth.register")}</Link>
                </p>
            </div>
        </div>
    );
