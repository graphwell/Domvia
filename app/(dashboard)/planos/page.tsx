    ...
    const plans = [
        {
            ...
            id: 'trial',
            price: 0,
            description: "Plano criado para novos usuários conhecerem as principais funcionalidades da plataforma.",
            features: [
                "20 créditos iniciais",
                "5 captações inteligentes",
                "2 documentos oficiais",
                "5 links de campanha",
                "IA especialista (5 sessões)",
                "Ganhe mais créditos indicando",
            ],
            cta: "Começar grátis",
            highlight: false,
        },
        {
            ...
            description: "Plano profissional para corretores que utilizam tecnologia diariamente.",
            features: [
                "500 créditos mensais",
                "150 captações inteligentes",
                "50 documentos oficiais",
                "100 links de campanha",
                "Landing Page do Imóvel (2 créditos)",
                "IA especialista (100 sessões/mês)",
        ...
        },
        {
            ...
            description: "Plano para corretores de alta performance e imobiliárias.",
            features: [
                "Uso ILIMITADO de todas as ferramentas",
                "Landing Pages ILIMITADAS",
                "Captações inteligentes ILIMITADAS",
                "Documentos e Links ILIMITADOS",
                "IA especialista sem limite de sessões",
                "Suporte prioritário",
