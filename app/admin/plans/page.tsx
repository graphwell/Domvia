...
const PLAN_ACCENT: Record<string, { gradient: string; badge: string; crown: string }> = {
    ...
    Starter: { gradient: "from-blue-500 to-blue-700", badge: "bg-blue-50 text-blue-700", crown: "text-blue-500" },
    Pro: { gradient: "from-indigo-500 to-indigo-700", badge: "bg-indigo-50 text-indigo-700", crown: "text-indigo-500" },
