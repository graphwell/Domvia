...
export const PLANS: Plan[] = [
    {
        ...
        features: [
            { label: "20 créditos iniciais", included: true },
            { label: "5 captações inteligentes", included: true },
            { label: "2 documentos oficiais", included: true },
            { label: "5 links de campanha", included: true },
            { label: "IA especialista (5 sessões)", included: true },
            { label: "Ganhe mais créditos indicando", included: true },
        ],
    },
    {
        id: "pro",
        ...
        features: [
            ...
            { label: "150 captações inteligentes", included: true },
            { label: "50 documentos oficiais", included: true },
            { label: "100 links de campanha", included: true },
            { label: "Landing Page do Imóvel (2 créditos)", included: true },
            { label: "IA especialista (100 sessões/mês)", included: true },
    ...
    },
    {
        ...
        features: [
            { label: "Uso ILIMITADO de todas as ferramentas", included: true },
            { label: "Landing Pages ILIMITADAS", included: true },
            { label: "Captações inteligentes ILIMITADAS", included: true },
            { label: "Documentos e Links ILIMITADOS", included: true },
            { label: "IA especialista sem limite de sessões", included: true },
